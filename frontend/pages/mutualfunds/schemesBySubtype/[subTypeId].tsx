...
import {
  initialLimit,
  initialOffset,
  mutualFundSchemesBySubtypeUrl,
} from "../../../configs/constants";
import { FundSubTypesPageProps } from "../../../types/props";
import { useState } from "react";

const FundSubType: React.FC<FundSubTypesPageProps> = ({
  schemes,
  schemeId,
  hasMore,
  error,
...
export const getServerSideProps: GetServerSideProps<FundSubTypesPageProps> =
  async ({ params }) => {
    try {
      const id = params!.subTypeId as string;
